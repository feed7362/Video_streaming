...
export const addToPlaylist = (playlistId: string, videoId: string): Promise<void> =>
    clientApi.post(`/playlists/${playlistId}/videos`, { videoId }).then(() => { });

export const deleteFromPlaylist = (playlistId: string, videoId: string): Promise<void> =>
...
export default { createPlaylist, getPlaylists, addToPlaylist, deleteFromPlaylist, deletePlaylist };
